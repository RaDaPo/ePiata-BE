...
--        (2, 'Ardei vrem', 'Aci langa', 'Second tender', '12', true, 'kg'),
--        (3, 'Mango vrem', 'Aci in zona', 'Third tender', '20', true, 'kg'),
--        (4, 'Avocado vrem', 'Aci dincolo', 'Fourth tender', '4', true, 'kg'),
--        (5, 'Lebenita vrem', 'langa tine', 'Fifth tender', '5', true, 'kg'),
--        (6, 'Ridichi vrem', 'Bihor', 'Sixth tender', '8', true, 'kg');
